    ...
    <div class="header">
      <div class="header_c">
        <el-row type="flex" justify="start" align="middle">
          ...
          <el-col :span="6" :offset="3" class="avatar-box" v-show="!isLogin">
            <router-link :to="{name: 'login', params: {type: 'login'}}" class="user-name">登录</router-link>
            <router-link :to="{name: 'login', params: {type: 'register'}}" class="collection">注册</router-link>
          </el-col>
        </el-row>
      </div>
    </div>
